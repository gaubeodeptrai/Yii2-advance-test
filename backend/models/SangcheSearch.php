...
/**
 * SangcheSearch represents the model behind the search form about `backend\models\Sangche`.
 */
class SangcheSearch extends Sangche
{
    ...
    public function rules()
    {
        return [
            ...
            [['so_don', 'so_don_uu_tien', 'ngay_cong_bo', 'ngay_don_cong_bo', 'IPC', 'file', 'file_video', 'ten_sang_che', 'tomtat', 'so_bang', 'ngay_cap_bang', 'ngay_nop_don', 'tacgia', 'chu_so_huu', 'chu_bang', 'ten_dai_dien', 'so_don_ptc', 'so_congbo_ptc', 'ngonngu'], 'safe'],
        ];
    }
